...
namespace Microsoft.AzureStack.Management.Backup.Admin
{
    ...
    public partial interface IBackupLocationsOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<BackupLocation>> ClearBackupLocationWithHttpMessagesAsync(string resourceGroupName, string location, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Update a backup location.
        /// </summary>
        /// <param name='resourceGroupName'>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<BackupLocation>> BeginClearBackupLocationWithHttpMessagesAsync(string resourceGroupName, string location, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Returns the list of backup locations.
        /// </summary>
